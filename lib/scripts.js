...
// // }
//
// // (runner)function clearFields() {
// //   $('#title-input').val('');
// //   $('#body-input').val('');
// //   $('#search-bar').val('');
// // }
//
// // (runner)function deleteIdeaFromStorage(idea) {
...
// // }
//
// // (runner)function findIdea(id) {
// //   return ideasList.find(function(idea) {
// //     return idea.id === parseInt(id);
// //   });
// // }
//
// // (runner)function generateNewIdea(titleInput, bodyInput) {
...
//   // }
//
// // (runner)function storeIdea() {
// //   localStorage.setItem("ideasList", JSON.stringify(ideasList));
// // }
//
// // (runner)function updateBody(id, newBody) {
// //   var idea = findIdea(id);
// //   idea.body = newBody;
// //   storeIdea();
// // }
//
// // (runner)function updateIdeasList(ideasList) {
// //   localStorage.setItem('ideasList', JSON.stringify(ideasList));
// //   storeIdea();
// // }
//
// // (runner)function updateTitle(id, newTitle) {
// //   var idea = findIdea(id);
// //   idea.title = newTitle;
// //   storeIdea();
// // }
//
// // (runner)function writeIdeas(ideasList) {
